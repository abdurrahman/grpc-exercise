...
_EXCHANGERATESRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='exchangeRate', full_name='ExchangeRatesResponse.exchangeRate', index=0,
...
_EXCHANGERATE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='currencyCode', full_name='ExchangeRate.currencyCode', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='unit', full_name='ExchangeRate.unit', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='currency', full_name='ExchangeRate.currency', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='forexBuying', full_name='ExchangeRate.forexBuying', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='forexSelling', full_name='ExchangeRate.forexSelling', index=4,
...
_EXCHANGERATESRESPONSE.fields_by_name['exchangeRate'].message_type = _EXCHANGERATE
...
_EXCHANGERATES = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetExchangeRatesStream',
    full_name='ExchangeRates.GetExchangeRatesStream',
    index=1,
    containing_service=None,
    input_type=_EMPTY,
